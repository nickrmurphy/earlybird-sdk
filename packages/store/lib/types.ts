...
export type DocumentFromSchema<S extends EntitySchema> = Document<EntityFromSchema<S>>;
 ...
 */
export type EntityFromSchema<S extends EntitySchema> =
    S extends EntitySchema<infer T> ? T : never;