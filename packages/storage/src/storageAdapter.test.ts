...
/**
 * Generic test suite factory for StorageAdapter implementations.
 * 
 * This function creates a comprehensive test suite that validates any StorageAdapter
 * implementation against the interface contract. Use this to ensure consistent
 * behavior across all storage adapters.
 * 
 * @param adapterFactory - Function that creates a fresh adapter instance for each test
 ...
 * ```
 */
export function createStorageAdapterTests(
